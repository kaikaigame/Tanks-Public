...
public class CameraControl : MonoBehaviour
{
    ...
    private void FindAveragePosition()
    {
        ...
        //If there are targets divide the sum of the positions 
        //by the number of them to find the average.
        if (numTargets > 0)
    ...
    private void Zoom()
    {
        //Find the required size based on the desired 
        //position and smoothly transition to that size.
    ...
    {
        //Find the position the camera rig is 
        //moving towards in its local space.
        ...
        for (int i = 0; i < m_Targets.Length; i++)
        {
            ...
            //Choose the largest out of the current size 
            //and the distance of the tank 'up' or 'down' from the camera.
            size = Mathf.Max(size, Mathf.Abs(desiredPosToTarget.y));

            //Choose the largest out of the current size and the 
            //calculated size based on the tank being to the left or right of the camera.
