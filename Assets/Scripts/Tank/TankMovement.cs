...
public class TankMovement : MonoBehaviour
{
    ...
    //This is set by this tank's manager.
    ...
    {
        //When the tank is turned off, 
        //set it to kinematic so it stops moving.
    ...
    private void EngineAudio()
    {
        ...
        {
            //Otherwise if the tank is moving and 
    ...
    private void Move()
    {
        //Create a vector in the direction the tank is facing with 
        //a magnitude based on the input, speed and the time between frames.
    ...
    private void Turn()
    {
        //Determine the number of degrees to be turned based on 
        //the input, speed and time between frames.
