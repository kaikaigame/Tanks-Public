...
public class TankHealth : MonoBehaviour
{
    ...
    //A prefab that will be instantiated in Awake, 
    //then used whenever the tank dies.
    ...
    private void Awake()
    {
        //Instantiate the explosion prefab and 
        //get a reference to the particle system on it.
    ...
    {
        //When the tank is enabled, reset the 
        //tank's health and whether or not it's dead.
    ...
    public void TakeDamage(float amount)
    {
        ...
        //If the current health is at or below zero and 
        //it has not yet been registered, call OnDeath.
    ...
    private void SetHealthUI()
    {
        ...
        //Interpolate the color of the bar between the choosen colours 
        //based on the current percentage of the starting health.
    ...
    private void OnDeath()
    {
        ...
        //Move the instantiated explosion prefab to 
        //the tank's position and turn it on.
